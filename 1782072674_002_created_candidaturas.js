...
migrate((app) => {
  ...
  const collection = new Collection({
    ...
    "fields":     [
          ...
          {
                "hidden": false,
                "id": "autodate6491837937",
                "name": "fecha_candidatura",
                "presentable": false,
                "primaryKey": false,
                "required": false,
                "system": false,
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_2831731187");
